...
/**
 * Represents the whole graph com.schema definition. It contains:
 * - propertyKeys
 * - vertexLabels
 * - edgeLabels
 * - vertexIndexes
...
class GraphSchema {
    ...
    /**
     * use the {@code mgmt} to create the com.schema
     * @param mgmt
     */
    public void make(JanusGraphManagement mgmt) {
        //create properties
...
/**
 * A utility class to read graph com.schema definition and write to JanusGraph
 */
class JanusGraphSONSchema {
     ...
     * @param graph a JanusGraph and write graph com.schema into it
     */
    ...
    /**
     * Read the graph com.schema definition from {@code schemaFile}
     * and write to the JanusGraph
     * @param schemaFile grah com.schema definition and using
     *        IBM graph com.schema format.
     */
    ...
    /**
     * Parse the graph com.schema definition and return a GraphSchema object
     * if parse successes
...
/**
 * parse the graph com.schema in {@code com.schema} and write to
 * {@code graph}
 * @param graph a valid JanusGraph instance
 * @param schema graph com.schema definition location
 * @return
 */
